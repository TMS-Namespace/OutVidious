...
public interface IDockPanelInterop : IAsyncDisposable
{
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>True if the operation succeeded.</returns>
    Task<bool> SetActivePanelAsync(string dockViewId, string panelTitle, CancellationToken cancellationToken);
    ...
    /// </summary>
    /// <param name="dockViewId">The DockViewV2 element ID.</param>
    /// <param name="panelKey">The key of the panel to check.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>True if the panel exists.</returns>
    Task<bool> PanelExistsByKeyAsync(string dockViewId, string panelKey, CancellationToken cancellationToken);
    ...
    Task<bool> IsDrawerReadyAsync(string dockViewId, string panelTitle, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>True if the operation succeeded.</returns>
    Task<bool> UnpinGroupByPanelKeyAsync(string dockViewId, string panelKey, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>True if the operation succeeded.</returns>
    Task<bool> SetActivePanelByKeyAsync(string dockViewId, string panelKey, CancellationToken cancellationToken);
