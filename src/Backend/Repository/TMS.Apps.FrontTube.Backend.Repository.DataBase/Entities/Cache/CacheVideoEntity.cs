...
/// Represents a video.
/// </summary>
public class CacheVideoEntity : EntityBase, ICacheableEntity
{
    ...
    public ICollection<CacheVideoThumbnailMapEntity> Thumbnails { get; set; } = [];

    public ICollection<CacheCaptionEntity> Captions { get; set; } = [];

    public ICollection<CacheStreamEntity> Streams { get; set; } = [];
